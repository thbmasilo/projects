...
<head>
    ...
    <title>Cash Cow Accounting Tool</title>
      ...
      <!-- Clouds -->
  	<link href="clouds2.css" rel="stylesheet">
...
<div id="up">
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li><a href="bootstrap-slider.php#slider2">HELP</a></li>
    ...
    <!-- Wrap the rest of the page in another container to center all the content. -->
			...
			<div class="down" id="getIt" align="center">
				...
				<div>
				 <p style="position:absolute;margin-top:60px;z-index:2;margin-left:1200px;"  class="pull-right"><a href="bootstrap-slider.php#slider2" class="btn btn-info btn-md">HELP</a></p>
     ...
     <div id="awan" style="height:100%; background-color: #C0DEED;">
	...
	<tbody><tr>
		<td>
											...
											<h1>10 Practice Exercises </h1>
												<br>
												Below is a list of questions and answers you may use interchangeably with your textbook. 
												<br><br>
												...
												<br>
											    <a class ="boardLink"href="newboard.html" onclick ="PassHeading('The owner open a small shoe store and deposited R 40 000.00 into the business bank account.'); "> Click here to try this question on the board. </a>	
											    <br>
												...
												<br>
												1. &nbsp;The owner pays monthly salaries and wages to staff to the value of R 4 500.00.
												<br>	
                                                <a class ="boardLink"href="newboard.html" onclick ="PassHeading('The owner pays monthly salaries and wages to staff of R 4 500.00.'); "> Click here to try this question on the board. </a>	
											    <br>												
												...
												<br>	
                                                 <a class ="boardLink"href="newboard.html" onclick ="PassHeading('The owner sells goods for cash to value of R 2 500.00.'); "> Click here to try this question on the board. </a>	
											    <br>												
												...
												<br>	
                                                <a class ="boardLink"href="newboard.html" onclick ="PassHeading('The owner draws money from the bank account and buys trading stock to value of R 5 500.00'); "> Click here to try this question on the board. </a>	
											    <br>																					
												...
												<br>
												1. &nbsp;The owner pays rent of R 6 000.00 for the month.
												<br>	
                                                 <a class ="boardLink"href="newboard.html" onclick ="PassHeading('The owner pays the shop rent for the month of R 6 000.00 ?'); "> Click here to try this question on the board. </a>	
											    <br>												
												...
												<br>	
                                                <a class ="boardLink"href="newboard.html" onclick ="PassHeading('The owner receives a payment of R 3 500.00 for services rendered.'); "> Click here to try this question on the board. </a>	
											    <br>															
												...
												<br>	
                                                 <a class ="boardLink"href="newboard.html" onclick ="PassHeading('The owner receives a short term loan from the bank for R 25 000.00.'); "> Click here to try this question on the board. </a>	
											    <br>															
												...
												<br>	
												<a class ="boardLink"href="newboard.html" onclick ="PassHeading('The owner buys trading stock from Blue Wholesaler on credit for R 2 500.00.'); "> Click here to try this question on the board. </a>	
											    <br>			
												...
												<br>	
                                                 <a class ="boardLink"href="newboard.html" onclick ="PassHeading('The owner sells goods for R 1 500.00 and place the money in the cash float.   The cost price of the goods is R 1000.00.'); "> Click here to try this question on the board. </a>	
											    <br>															
												...
												<br>
												1. &nbsp;The owner sells goods to Mr. Smith on credit for R 1 500.00.
												<br>	
                                                <a class ="boardLink"href="newboard.html" onclick ="PassHeading('The owner sells good to a client Mr. Smith on credit for R 1 500.00.'); "> Click here to try this question on the board.</a>	
											    <br>															
        ...
        <!-- FOOTER -->
        <footer>
                 <p  class="pull-right"><a id="down" href="#up" class="btn btn-info btn-md" style="position: absolute; right: 50px;">UP</a>
            <p style="position: absolute; left: 50px;">&copy; Accounting Tool 2015. &middot; <a href="#" >Privacy</a> &middot; </p>
        </footer>
...
<!--
		 ...
		 function CheckScore()
    {
		...
		function PassHeading( Q1 )
		{


           sessionStorage.setItem('key', Q1);
