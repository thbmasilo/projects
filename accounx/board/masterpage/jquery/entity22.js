				...
				*/
                $('#sdt_menu > li.Assets').bind('click',function(){
					...
					$elem.find('img')
						 ...
						 .find('.sdt_wrap')
					     .stop(true)
						 .animate({'top':'700%','width':'300%', 'left':'740%','height':'300%'},500,'easeOutBack')
						 .andSelf()
						 .find('.sdt_active')
					     .stop(true)
				...
				*/
                $('#sdt_menu > li.Liabilities').bind('click',function(){
					...
					$elem.find('img')
						 ...
						 .find('.sdt_wrap')
					     .stop(true)
						 .animate({'top':'700%','width':'400%', 'left':'90%','height':'300%'},500,'easeOutBack')
						 .andSelf()
						 .find('.sdt_active')
					     .stop(true)
				...
				*/
                $('#sdt_menu > li.Incomes').bind('click',function(){
					...
					$elem.find('img')
						 ...
						 .find('.sdt_wrap')
					     .stop(true)
						 .animate({'left':'-780%', 'top':'340%', 'width':'350%','height':'300%'},500,'easeOutBack')
						 .andSelf()
						 .find('.sdt_active')
					     .stop(true)
				...
				*/
                $('#sdt_menu > li.Owners').bind('click',function(){
					...
					$elem.find('img')
						 ...
						 .find('.sdt_wrap')
					     .stop(true)
						 .animate({'top':'5%','width':'190%', 'left':'-55%','height':'300%'},500,'easeOutBack')
						 .andSelf()
						 .find('.sdt_active')
					     .stop(true)
						 .animate({'height':'750%','width':'175%', 'left':'-55%', 'top':'-170%'},300,function(){
					...
					$elem.find('.sdt_wrap').animate({'marginLeft': '-20%'});
				}).bind('mouseleave',function(){
					var $elem = $(this);
					var $sub_menu = $elem.find('#Owner1');
					if($sub_menu.length)
					...
					$elem.find('.sdt_active')
						 ...
						 .stop(true)
						 .animate({'top':'25%', 'left':'0%'},500);
						 $elem.find('.sdt_wrap').animate({'marginLeft': '-25%'});
				});
            });	
$(function() {
				/**
				...
				*/
                $('#sdt_menu > li.Expenses').bind('click',function(){
					...
					$elem.find('img')
						 ...
						 .find('.sdt_wrap')
					     .stop(true)
						 .animate({'top':'20%','width':'380%', 'left':'540%','height':'300%'},500,'easeOutBack')
						 .andSelf()
						 .find('.sdt_active')
					     .stop(true)
