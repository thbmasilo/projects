...
<p></p>
			...
			<ul id="sdt_menu" class="sdt_menu">
				...
				<li class="Assets" onClick="AssetsShow()" id="Assets">
					...
					<h5>Current Assets<br>(Short Term)<hr></h5>
							<a href="#" id="accounts" onClick="CountAccount('Assets', ' TRADING STOCK');">TRADING STOCK</a>
							<a href="#" id="accounts" onClick="CountAccount('Assets', ' DEBITORS-CONTROL');">DEBITORS-CONTROL</a>
							<a href="#" id="accounts" onClick="CountAccount('Assets', 'BANK(DEBIT) BALANCE');">BANK<br>(DEBIT)<br>BALANCE</a>
							<a href="#" id="accounts" onClick="CountAccount('Assets', ' CASH FLOAT');">CASH FLOAT</a>
					</div>
					<div class="sdt_box2">
					  <h5>Non-Current Assets<br>(Long Term)<hr>Financial Assets</h5><br>
							<a href="#" id="accounts" onClick="CountAccount('Assets', 'FIXED DEPOSIT');">FIXED DEPOSIT</a><br>

					</div>
                    <div class="sdt_box3">
					    <h5><hr>Fixed/Tangible Assets</h5>
							<a href="#" id="accounts" onClick="CountAccount('Assets', 'LAND & BUILDINGS');">LAND & BUILDINGS</a>
							<a href="#" id="accounts" onClick="CountAccount('Assets','VEHICLES');">VEHICLES</a>
				            <a href="#" id="accounts" onClick="CountAccount('Assets', 'EQUIPMENT');">EQUIPMENT</a><br>
					</div>
				</li>
				<li class="Liabilities" onClick="LiabilitiesShow()" id="Liabilities">
					...
					<div class="sdt_box">
					  <h5>Current liabilities<br>(LongTerm)<hr></h5>
							<a href="#" id="accounts" onClick="CountAccount('Liabilities','CREDITORS CONTROL');">CREDITORS CONTROL</a>
							<a href="#" id="accounts" onClick="CountAccount('Liabilities','BANK (CREDIT BALANCE OVERDRAFT)');">BANK<br>(CREDIT BALANCE OVERDRAFT)</a>
							<a href="#" id="accounts" onClick="CountAccount('Liabilities','SHORT TERM LOAN');">SHORT TERM LOAN</a>
					</div>
					<div class="sdt_box2">
					  <h5>Non Current liabilities<br>(LongTerm)<hr></h5>
							<a href="#" id="accounts" onClick="CountAccount('Liabilities','MORTGAGE');">MORTGAGE</a>
							<a href="#" id="accounts" onClick="CountAccount('Liabilities','LONG TERM LOAN');">LONG TERM LOAN</a>
					</div>
				</li>
				<li class="Owners" onClick="ownerShow()" id="Owners">
					...
					<div class="sdt_box">
							<a href="#" id="accounts" onClick="CountAccount('OWNER EQUITY','CAPITAL');">CAPITAL</a>
							<a href="#" id="accounts" onClick="CountAccount('OWNER EQUITY','DRAWINGS');">DRAWINGS</a>
					</div>
				...
				<li class="Incomes" onClick="IncomeShow()" id="Incomes">
					...
					<div class="sdt_box">
						...
						<a href="#" id="accounts" onClick="CountAccount('INCOME',' SALES');">SALES</a><br><br>

						<h5>Other Income<hr></h5><br>

                        <a href="#" id="accounts" onClick="CountAccount('INCOME','RENT INCOME');">RENT INCOME</a>
					</div>
					<div class="sdt_box2">
					    <h5>Service Business<hr>Main/Current Income</h5><br>
						<a href="#" id="accounts" onClick="CountAccount('INCOME','SERVICES RENDERED');">SERVICES RENDERED</a>
						<a href="#" id="accounts" onClick="CountAccount('INCOME',' COMMISSION INCOME');">COMMISSION INCOME</a><br><br><br>
						<h5>Other Income<hr></h5><br>
						<a href="#" id="accounts" onClick="CountAccount('INCOME',' RENT INCOME ');">RENT INCOME</a>
					</div>
				</li>
				<li class="Expenses" onClick="ExpensesShow()" id="Expenses">
					...
					<div class="sdt_box">
						<a href="#" id="accounts" onClick="CountAccount('EXPENSE',' MATERIAL COSTS ');">MATERIAL COSTS</a>
						<a href="#" id="accounts" onClick="CountAccount('EXPENSE',' DEBITORS-ALLOWANCES ');">DEBITORS-ALLOWANCES</a>
						<a href="#" id="accounts" onClick="CountAccount('EXPENSE',' WATER & ELECTRICITY ');">WATER & ELECTRICITY</a>
						<a href="#" id="accounts" onClick="CountAccount('EXPENSE',' WAGES & SALARIES ');">WAGES & SALARIES</a>
						<a href="#" id="accounts" onClick="CountAccount('EXPENSE',' COST OF SALES ');">COST OF SALES</a>
					</div>
					<div class="sdt_box2">
							<a href="#" id="accounts" onClick="CountAccount('EXPENSE',' RENT EXPENSE');">RENT EXPENSE</a>
							<a href="#" id="accounts" onClick="CountAccount('EXPENSE',' ADVERTISING ');">ADVERTISING</a>
							<a href="#" id="accounts" onClick="CountAccount('EXPENSE',' FUEL ');">FUEL</a>
						    <a href="#" id="accounts" onClick="CountAccount('EXPENSE',' REPAIRS ');">REPAIRS</a>
					</div>
					<div class="sdt_box3">
					    <a href="#" id="accounts" onClick="CountAccount('EXPENSE',' PACKING MATERIAL ');">PACKING MATERIAL</a>
						<a href="#" id="accounts" onClick="CountAccount('EXPENSE',' STATIONERY ');">STATIONERY</a>
						<a href="#" id="accounts" onClick="CountAccount('EXPENSE',' INSURANCE ');">INSURANCE</a>
	       				<a href="#" id="accounts" onClick="CountAccount('EXPENSE',' TRADING LICENCE ');">TRADING LICENCE</a>
						<a href="#" id="accounts" onClick="CountAccount('EXPENSE',' TELEPHONE ');">TELEPHONE</a>
					</div>
				</li>
			</ul>
		</div>
        ...
        <script src="jquery/entity.js"></script>
